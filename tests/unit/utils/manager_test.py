...
class ManagerTest(unittest.TestCase):
    ...
    def test_get_genetic_optimizer_with_configs(self):
        """
        Test to acquire a genetic optimizer by providing 
        the partiion, epochs and gene range in the configs
        """
        model = torch.nn.Linear(20, 40)
        configs = {}
        configs["optimizer"] = "genetic"
    ...
    def test_get_genetic_optimizer_wrong_gene_range(self):
        """
        Test to acquire a genetic optimizer by providing 
        an wrong shape for the gene range
        """
        model = torch.nn.Linear(20, 40)
        configs = {}
        configs["optimizer"] = "genetic"
    ...
    def test_get_adam_missing_configs(self):
        """
        KeyError is raised if the "learning rate" parameter is not specified in the configs
        when trying to acquire an adam optimizer
        """
        configs = {}
        configs["optimizer"] = "adam"
    ...
    def test_get_optimizer_none(self):
        ...
        with self.assertRaises(AssertionError):
            optim = get_optimizer(torch.nn.Linear(20, 44), configs)
    ...
    def test_get_optimizer_elm(self):
        """
        Test for acquiring an elm optimizer
        """
        configs = {}
        configs["optimizer"] = "elm"

    def test_get_algorithm_ga(self):
        """
        Test for the get_algorithm() method which returns a genetic algorithm train function based on the configs. 
    ...
    def test_get_algorithm_gd(self):
        """
        Test for the get_algorithm() method which returns a gradient descent train function based on the configs. 
